...
for train_index, test_index in cv:
    ...
    estimator = RandomSurvivalForest(
        n_estimators=200, max_features = 50, min_samples_leaf= 20, random_state=random_state
    )
...
# n_estimators=200, max_features = 50, min_samples_leaf = 20
...
# Score on train set 
print(rsf.score(X_train, structured_y_train)) # 0.7716742991176142
# Score on test set 
