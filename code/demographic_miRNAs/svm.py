...
for train_index, test_index in cv:
    ...
    estimator.set_params(**{'alpha': 0.0001, 'kernel': 'linear', 'solver': 'osqp'})
    ...
    pd.DataFrame({'score': scores}).to_csv("/Users/nguyenthao/Desktop/UTS/TranLab/research_project/data/signed_ranks_test/demographic_miRNAs/svm.csv", index=False)


# {'alpha': 0.0001, 'kernel': 'linear', 'solver': 'osqp'}
...
print(score_survival_model(estimator, X_train, structured_y_train)) # 0.6337763878029711
print(score_survival_model(estimator, X_test, structured_y_test)) # 0.5351876675603218