...
# ### Cox ####
# demographic_cox = list(pd.read_csv("../../data/signed_ranks_test/demographic/cox.csv")['score'])
# demographic_isomiRs_cox = list(pd.read_csv("../../data/signed_ranks_test/demographic_isomiRs/cox.csv")['score'])
...
# ### RSF ####
# demographic_rsf = list(pd.read_csv("../../data/signed_ranks_test/demographic/rsf.csv")['score'])
# demographic_isomiRs_rsf = list(pd.read_csv("../../data/signed_ranks_test/demographic_isomiRs/rsf.csv")['score'])
...
# #### SVM ####
# demographic_svm = list(pd.read_csv("../../data/signed_ranks_test/demographic/svm.csv")['score'])
# demographic_isomiRs_svm = list(pd.read_csv("../../data/signed_ranks_test/demographic_isomiRs/svm.csv")['score'])
...
### Cox ####
demographic_cox = list(pd.read_csv("../../data/signed_ranks_test/demographic/cox.csv")['score'])
demographic_miRNAs_cox = list(pd.read_csv("../../data/signed_ranks_test/demographic_miRNAs/cox.csv")['score'])
...
### RSF ####
demographic_rsf = list(pd.read_csv("../../data/signed_ranks_test/demographic/rsf.csv")['score'])
demographic_miRNAs_rsf = list(pd.read_csv("../../data/signed_ranks_test/demographic_miRNAs/rsf.csv")['score'])
...
### SVM ####
demographic_svm = list(pd.read_csv("../../data/signed_ranks_test/demographic/svm.csv")['score'])
demographic_miRNAs_svm = list(pd.read_csv("../../data/signed_ranks_test/demographic_miRNAs/svm.csv")['score'])
